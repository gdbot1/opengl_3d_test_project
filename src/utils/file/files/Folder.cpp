...
void fls::Folder::add(std::shared_ptr<fls::File> file) {
...
std::shared_ptr<fls::File> fls::Folder::get(const std::string &name) const {
...
std::vector<std::shared_ptr<fls::File>> fls::Folder::getFiles() const {
    return this->files;
}